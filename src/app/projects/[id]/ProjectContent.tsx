      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <header className="flex justify-between items-center mb-12">
          ...
          <div className="space-y-2 text-right">
            ...
            <div className="text-2xl font-extralight">wayfinding</div>
          </div>
        </header>

        <ImageCarousel images={['/placeholder-gray.jpg', '/placeholder-gray.jpg', '/placeholder-gray.jpg', '/placeholder-gray.jpg', '/placeholder-gray.jpg']} />
        ...
        <div className="flex justify-between items-center mt-8">
          ...
          <div className="flex items-center gap-8">
            <div className="rotate-180 text-2xl font-extralight">
              A Form of Practice
            </div>
